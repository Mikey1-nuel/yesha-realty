    ...
    <main>
      ...
      <section className="real-estate-hero">
        <div className="real-estate-text">
          ...
          <a
            href="https://chat.whatsapp.com/ImwZzs4fRfg2knXAtV125K"
            target="_blank"
            rel="noopener noreferrer"
          >
            <button className="create-account">Join Our Agent Group</button>
          </a>
        </div>
        ...
        <div className="real-estate-agent">
          <Image
            ...
            alt="Professional real estate agent in suit holding a bullseye symbolizing career focus and success"
            width={500}
            height={700}
          />
        </div>
